      ...
      <main>
        <section className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
          ...
          <FloatingOrb
            delay={0}
            duration={8}
            className="w-96 h-96 bg-indigo-500 top-1/4 left-1/4"
          />
          <FloatingOrb
            delay={2}
            duration={10}
            className="w-80 h-80 bg-purple-500 bottom-1/4 right-1/4"
          />
          <FloatingOrb
            delay={4}
            duration={12}
            className="w-72 h-72 bg-pink-500 top-1/2 right-1/3"
          />
        ...
        <section className="py-24 bg-linear-to-b from-slate-900 to-slate-950 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops))] from-indigo-900/20 via-transparent to-transparent"></div>
        </section>
      </main>
